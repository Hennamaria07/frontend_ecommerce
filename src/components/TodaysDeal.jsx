...
const TodaysDeal = () => {
    ...
    const items = [
        <div className="w-full w-[300px] bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        <a href="#">
        ...
        <>
            <section className='md:px-32 px-16 sm:py-10 py-5'>
                <div className='flex gap-2 pb-2 items-center '>
                    ...
                    <h3 className='text-sm text-[#043E44] dark:text-[#8CB9BD]'>Today's Deals</h3>
                </div>
                <h2 className='font-bold sm:text-4xl  dark:text-white text-2xl pb-5'>Best Offers</h2>
