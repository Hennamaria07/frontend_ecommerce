    ...
    <>
     <section className='md:px-32 px-16 sm:pb-10 pb-5'>
         ...
         <div className='catagories-group grid gap-5 lg:grid-cols-5 md:grid-cols-3 sm:grid-cols-2'>
            <div className='min-w-[170px] bg-white dark:bg-gray-800 min-h-[145px] cursor-pointer hover:text-white hover:bg-[#043E44] text-[#043E44] dark:text-[#8CB9BD] dark:hover:text-gray-900 dark:hover:bg-[#8CB9BD] rounded-md flex justify-center items-center border-2 border-[#043E44] dark:border-[#8CB9BD]'>
                <h5>Phones</h5>
            </div>
            <div className='min-w-[170px] bg-white dark:bg-gray-800 min-h-[145px] cursor-pointer hover:text-white hover:bg-[#043E44] text-[#043E44] dark:text-[#8CB9BD] dark:hover:text-gray-900 dark:hover:bg-[#8CB9BD] rounded-md flex justify-center items-center border-2 border-[#043E44] dark:border-[#8CB9BD]'>
                <h5>Phones</h5>
