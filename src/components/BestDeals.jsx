...
const BestDeals = () => {
  return (
    <>
      <section className='md:px-32 px-16 sm:pb-10 pb-5 text-gray-900 dark:text-slate-200'>
        ...
        <div className='grid gap-5 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-12 xl:grid-rows-2 grid-rows-1'>
          <article className="hidden xl:grid xl:col-span-5 xl:row-span-2 row-span-1 w-full bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            ...
            <div className="px-5 xl:pb-10 pb-5">
              <h6 className='text-[#043E44] text-sm lg:text-lg dark:text-white font-semibold'>Brand Name</h6>
              <a href="#">
                <h5 className="text-lg lg:py-5 lg:text-2xl font-semibold tracking-tight text-gray-900 dark:text-white">Apple Watch Series 7 GPS, Aluminium Case, Starlight Sport</h5>
              </a>
              ...
              <div className="flex items-center justify-between">
                ...
                <Link>
                  <button className='bg-[#043E44] dark:bg-[#8CB9BD] py-2 px-4 text-slate-200 dark:text-gray-900 rounded-md'>
                    Add to Cart
                  </button>
                </Link>
              </div>
          ...
          <article className=" xl:col-span-3 xl:row-span-1 row-span-1 w-full bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            <a href="#">
